...
class TestInvitation():
    ...
    ### Tests ###
    ### Tests for Property manager profile

    # def test_profile_update_profile(self):
    #     #TODO implement test steps and assertions
    #     assert False
    #
    # ### Tests for Property details tab on Property manager dashboard header
    #
    ...
    #
    #
    # ### Tests for Property editor tab on Property manager dashboard header
    #
    ...
    #     assert False
    #
    # ### Test for Maintenance requests tab on Property manager dashboard header
    #
    ...
    #     assert False
    #
    # ### Tests for Payments tab on Property manager dashboard header
    #
    ...
    #     assert False
    #
    # ### Tests for Management tab on Property manager dashboard header
    #
